...
Chris: {
	...
	details: [
		v('p', {classes: [ui.largeP, css.max]}, [v('b', [`This talk gives an overview of ActivityPub: `]), v('br'),
...
Luc: {
	...
	byline: 'Luc Didry',
	details: [
		v('p', {classes: ui.largeP}, [ v('b', [`Hosting an ActivityPub service is not like hosting another service `]),
...
Maloki: {
	...
	details: [ v('p', {classes: ui.largeP}, [
		v('b', [`A talk about how we're walking away from Web 2.0,
and paving the way to Web 3.0 with ActivityPub development. `]),v('br'),
...
Pukkamustard: {
	...
	byline: 'Pukkamustard',
	details: [ v('p', {classes: ui.largeP}, [v('b', [`ActivityPub uses JSON-LD as serialization. `]),
...
Serge: {
	...
	details: [ v('p', {classes: ui.largeP}, [v('b', [`Spam, scams and harassment `]),
`pose a threat to all social networks, including the Fediverse.`,v('br'),v('br'),
...
Schmittlauch: {
	...
	byline: 'Schmittlauch',
	details: [ v('p', {classes: ui.largeP}, [v('b', [`Hashtags have become an important tool for organising topic-related
...
Cristina: {
	...
	details: [ v('p', {classes: ui.largeP}, [
v('b', [`Privacy is becoming more and more central in shaping the future of tech `]),
...
Caleb: {
	...
	details: [
		v('p', {classes: ui.largeP}, [v('b', [`Despite it's significant contribution to internet culture, `]),
...
Matt: {
	...
	byline: 'Matt Baer',
	details: [ v('p', {classes: ui.largeP}, [v('b', [`We're building out one idea of what federated blogging could look like `]),
`with separate ActivityPub-powered platforms, WriteFreely and Read.as
– one for writing and and one for reading.`,v('br'),v('br'),`Beyond the software, we're also offering hosting services and
...
hands.`,v('br'),v('br'),`In this talk I'll go over our approach so far and where we're headed next.`])
	],
	img: '01_Matt'
},
Michael: {
	...
	details: [ v('p', {classes: ui.largeP}, [v('b', [`A newbie's introduction to ActivityPub: `]), v('br'),
...
Mark: {
	...
	details: [ v('p', {classes: ui.largeP}, [
		v('p', {classes: [ui.largeP, css.max]}, [v('b', [
