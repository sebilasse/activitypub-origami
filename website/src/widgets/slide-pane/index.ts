...
import * as css from '../themes/redaktor-default/slide-pane.m.css';
...
export class SlidePaneBase<P extends SlidePaneProperties = SlidePaneProperties> extends i18nBase<P> {
