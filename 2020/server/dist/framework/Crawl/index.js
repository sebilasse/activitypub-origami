...
class HeadlessCrawler extends EventEmitter {
    ...
    static async launch(options) {
        const { ignoreHTTPSErrors, headless, executablePath, slowMo, args, ignoreDefaultArgs, handleSIGINT, handleSIGTERM, handleSIGHUP, dumpio, userDataDir, env, devtools } = options, CRAWL = __rest(options, ["ignoreHTTPSErrors", "headless", "executablePath", "slowMo", "args", "ignoreDefaultArgs", "handleSIGINT", "handleSIGTERM", "handleSIGHUP", "dumpio", "userDataDir", "env", "devtools"]);
        const LAUNCH = {
    ...
    static async connect(options) {
        const { browserWSEndpoint, ignoreHTTPSErrors } = options, CRAWL = __rest(options, ["browserWSEndpoint", "ignoreHTTPSErrors"]);
