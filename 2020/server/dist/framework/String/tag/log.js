...
exports._log = exports.pwStr = exports.syntaxHighlight = exports.syntaxColor = exports.dumpError = exports.syntaxLog = exports.info = exports.muted = exports.neutral = exports.output = exports.input = exports.list = exports.error = exports.warning = exports.success = exports.message = exports.reset = exports.log = exports._ = void 0;
const has_1 = require("@dojo/framework/core/has");
const string_1 = require("@dojo/framework/shim/string");
const R = [31, '#DC0005'];
const G = [32, '#95CC0D'];
const B = [34, '#0D7ECC'];
const C = [36, '#1397A3'];
...
function _(strings, ...values) {
    ...
    const s = strings.reduce((result, string, i) => {
        ...
        const color = Object.keys(colorCodes).filter(k => string_1.endsWith(string, `${k}`))[0];
        if (color) {
