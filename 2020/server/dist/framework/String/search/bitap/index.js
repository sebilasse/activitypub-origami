...
exports.patternAlphabet = exports.regexSearch = exports.SPECIAL_CHARS_REGEX = void 0;
...
class Bitap {
    ...
    search(text) {
        ...
        if (this.pattern === text) {
            return Object.assign({ isMatch: true, score: 0, matchedIndices: [[0, text.length]] }, searchBase);
        }
        ...
        return Object.assign(Object.assign({}, bitapSearch_1.default(text, this.pattern, this.patternAlphabet, {
            location,
            distance,
            threshold,
            findAllMatches,
