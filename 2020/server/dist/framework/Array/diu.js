...
exports.unionWith = exports.unionBy = exports.intersectionWith = exports.intersectionBy = exports.differenceWith = exports.differenceBy = exports.union = exports.intersection = exports.difference = exports.xorWith = exports.xorBy = exports.xor = exports.without = exports.pullAllBy = exports.pull = exports.pullAll = void 0;
...
_c = diuFns.map((k) => (a, ...values) => _diu(a, values, { [k]: 1 })), exports.difference = _c[0], exports.intersection = _c[1], exports.union = _c[2];
_d = diuFns.reduce((a, k) => a.concat([
    (a, ...b) => _diu_byWith(a, b, { [k]: 1 }),
    (a, ...b) => _diu_byWith(a, b, { [k]: 1, with: 1 })
]), []), exports.differenceBy = _d[0], exports.differenceWith = _d[1], exports.intersectionBy = _d[2], exports.intersectionWith = _d[3], exports.unionBy = _d[4], exports.unionWith = _d[5];
