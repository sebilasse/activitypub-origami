...
/*
Deutsch: Margaret Hamilton neben den Ausdrucken der von ihr und ihrem Team für das Apollo-Projekt entwickelten Flugsoftware.
Español: Margaret Hamilton junto al software de navegación que ella y su equipo MIT produjeron para el Programa Apolo.
Français : Margaret Hamilton se tenant auprès du code du logiciel de navigation qu'elle et son équipe ont produit pour le programme Apollo.
Italiano: Margaret Hamilton nel 1969, accanto al codice sorgente del software dell'Apollo Guidance Computer scritto da lei e dal suo team all'MIT.
Polski: Margaret Hamilton stojąca obok oprogramowania nawigacyjnego, które ona i jej zespół z MIT stworzyli dla programu Apollo.
Português: Margaret Hamilton em 1969, ao lado de listagens que ela e sua equipe no MIT produziram para o Programa Apollo.
*/
